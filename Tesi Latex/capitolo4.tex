...
Si descrivono di seguito i singoli subVI e le loro funzionalità.
\begin{description}
...
\item[\textit{PeaksDetector.vi}] Lo scopo di questo subVI è quello di trovare, attraverso la funzione \emph{Waveform Peak Detection.vi} 
\item[\textit{FindWavefromIntegral.vi}]
\item[\textit{CreateSpectrum.vi}]
\item[\textit{}]
\item[\textit{}] 
\end{description}