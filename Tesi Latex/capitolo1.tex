...
\begin{description}
  \item[Monocromatore] Per quanto riguarda la parte di interfaccia che permette di impostare correttamente il monocromatore è necessario poter modificare il grating (1200 o 2400) e la calibrazione di correzione relativa. Si deve anche poter modificare la slit di entrata e la lunghezza d'onda;
...
\end{description}
\textbf{Descrivere principali funzioni e oggetti: strutture e cicli, controlli e indicatori e fili}