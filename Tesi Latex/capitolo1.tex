...
%\lhead[\fancyplain{}{\bfseries\thepage}]{\fancyplain{}{\bfseries Documento dei requisiti}}
...
\item Exposure Time: tempo di esposizione, deve essere maggiore di zero e si deve poter specificare l'unità di misura
...
\item[Block Diagram]Finestra in cui si compone il codice a blocchi, controlli, indicatori, subVI e moltre alte componenti. Da tale finestra è possibile effettuare il debug del codice e controllare il contenuto delle variabili.
\end{description}
